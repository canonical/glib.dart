...
mixin GTimeZoneFfiMixin on GTimeZoneMixin {
  ...
  GTimeZone g_time_zone_new_identifier(String identifier) {
    return ffi.using((arena) {
      ...
      return GTimeZoneFfi(libglib.g_time_zone_new_identifier(id));
    });
  }

  @override
  GTimeZone g_time_zone_new_utc() =>
      GTimeZoneFfi(libglib.g_time_zone_new_utc());

  @override
  GTimeZone g_time_zone_new_local() =>
      GTimeZoneFfi(libglib.g_time_zone_new_local());
}

class GTimeZoneFfi extends GTimeZone implements ffi.Finalizable {
  GTimeZoneFfi(this._ptr) {
    finalizer.attach(this, _ptr, libglib.addresses.g_time_zone_unref);
  }
  ...
  gint adjust_time(GTimeType type, gint64 time) {
    return ffi.using((arena) {
      ...
      return libglib.g_time_zone_adjust_time(_ptr, type, t);
    });
  }

  @override
  gint find_interval(GTimeType type, gint64 time) {
    return libglib.g_time_zone_find_interval(_ptr, type, time);
  }

  @override
  String get_abbreviation(gint interval) {
    return libglib.g_time_zone_get_abbreviation(_ptr, interval).toDartString()!;
  }

  @override
  String get_identifier() {
    return libglib.g_time_zone_get_identifier(_ptr).toDartString()!;
  }

  @override
  gint32 get_offset(gint interval) {
    return libglib.g_time_zone_get_offset(_ptr, interval);
  }

  @override
  gboolean is_dst(gint interval) {
    return libglib.g_time_zone_is_dst(_ptr, interval) != 0;
  }
}
